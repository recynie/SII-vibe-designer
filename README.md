...
> 🎯 **题目正式交付物 → [`docs/demo-runs/run-final-hardened/`](./docs/demo-runs/run-final-hardened/)**（创智学院 4 类全套、12 分钟、强化 prompt 版本）。其余 5 个 run 是泛化、技术验证或恢复实证。
...
# 检查 README / CHANGELOG / defense-qa 的事实陈述与实际仓库一致

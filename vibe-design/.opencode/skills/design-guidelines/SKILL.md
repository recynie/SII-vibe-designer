...
description: |
  设计方向与交付物类型参考。覆盖 5 种视觉风格方向（无品牌资产时的审美种子）和多种设计产品类别（主视觉图、文创物料、宣传海报、Logo、品牌文案、UI mockup 等）。
  Use when planning brand-spec.md or deliverables.md — helps researcher choose visual direction and product types; helps designer find execution guidance for specific deliverable forms.
---
...
无品牌资产时，从以下 5 种方向中选择最匹配 brief 调性的一种，Read 对应文件获取完整色板、字体、posture：
...
有品牌资产时跳过方向选择，从 facts.md 提取色板/字体。
...
| 品牌文案 | 纯 markdown | Write md | `deliverables/copywriting.md` |
...
3. **色板 + 质感** — brand-spec 的 hex 锚点；材质/肌理关键词

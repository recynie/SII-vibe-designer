...
description: |
  设计方向与交付物类型参考。覆盖 5 种视觉风格方向（无品牌资产时的审美种子）和多种视觉设计产品类别（主视觉图、文创物料、宣传海报、Logo、Mockup 合成图等）。
...
| Mockup（合成图） | PNG 效果图 / HTML + 渲 PNG | gen_image / html_screenshot | `deliverables/mockup.md` |

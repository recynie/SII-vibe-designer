...
下面是**视觉类任务**（logo / poster / ui-mockup）的标准 5 维度。**copy / 文案类任务允许换维度**——把 ② 信息层级、③ 视觉品味替换成「记忆点 / 语言精准度 / 情感共鸣」之类更贴文案的轴，但「① 品牌契合 + ④ 反 AI slop（一票否决）+ ⑤ 任务完成度」这三个维度**必须保留**。无论换不换名字，5 项 0-10 + 通过门槛规则不变。
